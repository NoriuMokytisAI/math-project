...
export const curriculum = {
  "5": [
    ...
    "Geometrinės transformacijos: atspindys, postūmis ir posūkis",
    "Algebra",
    "Geometrija",
    "Kombinatorika",
    "Skaičių teorija",
  ...
  "7": [
    ...
    "Laipsniai ir šaknys",
    "Finansiniai skaičiavimai: biudžetas ir palūkanos",
    ...
    "Imtys, duomenų analizė ir diagramos",
  ...
  "8": [
    ...
    "Tiesinis sąryšis ir tiesinė funkcija",
  ...
  "9": [
    ...
    "Kvadratinė funkcija ir lygtys",
    "Kvadratinis trinaris ir trupmeniniai racionalieji reiškiniai",
    "Lygčių sistemos su kvadratinėmis ir racionaliosiomis lygtimis",
