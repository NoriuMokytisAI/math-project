...
\begin{tcolorbox}[title=III gimnazijos kurso žemėlapis, colback=blue!5]
Šios klasės kursas remiasi trimis ankstesnių metų atramomis: tiksliais algebriniais pertvarkiais, funkcijų grafikų skaitymu ir geometrijos bei tikimybių modeliais. Prieš pradedant naują temą verta sąmoningai pasitikrinti, kokių ankstesnių įgūdžių reikės.

\begin{itemize}
\item \textbf{Sekos ir indukcija} remiasi dėsningumais, reiškiniais ir funkcijos samprata; prieš įrodymus reikia mokėti tvarkingai pertvarkyti sumas ir sandaugas.
\item \textbf{Laipsninės, rodiklinės, logaritminės ir trigonometrinės funkcijos} remiasi realiųjų skaičių intervalais, laipsniais, šaknimis, logaritmų pradmenimis ir funkcijų savybėmis iš \ref{sec:realieji-skaiciai-ir-intervalai}, \ref{sec:laipsniai-saknys-ir-logaritmu-pradzia} ir \ref{sec:funkcijos-ir-ju-savybes}.
\item \textbf{Ribos, tolydumas ir išvestinė} remiasi funkcijų grafikais, vidutiniu kitimo greičiu, tiesės krypties koeficientu ir algebriniu reiškinių supaprastinimu.
\item \textbf{Vektoriai, analitinė ir erdvės geometrija} remiasi koordinatėmis, Pitagoro teorema, panašumu, trigonometrija stačiajame trikampyje ir erdvinių kūnų matavimais.
\item \textbf{Statistika, tikimybė ir kombinatorika} remiasi imties, dažnio, vidurkio, sklaidos, baigčių aibės ir klasikinių tikimybių sampratomis.
\end{itemize}

Jei šiame skyriuje sprendimas stringa, pirmiausia klauskite ne „kokia formulė?“, o „kokia ankstesnė idėja čia atpažįstama?“ Tai padeda atskirti procedūrą nuo priežasties, kodėl ji veikia.
\end{tcolorbox}

\section{Sekos ir matematinė indukcija}\label{sec:sekos-ir-matematine-indukcija}

\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Reikia mokėti atpažinti dėsningumus, sudaryti raidinius reiškinius, taikyti veiksmų tvarką ir suprasti funkciją kaip taisyklę, kuri kiekvienam argumento skaičiui priskiria reikšmę.
\end{tcolorbox}
...
\subsection{Mokymosi gidas ir savikontrolė}

Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Sekos ir matematinė indukcija}, svarbiausia suprasti kintamųjų prasmę, apibrėžimo sritį, lygiaverčius pertvarkius, grafiką ir rezultato interpretaciją.

\textbf{Kaip mokytis.} Perskaitykite apibrėžtis, prie kiekvienos parašykite po savo pavyzdį ir vieną nepavyzdį. Spręsdami uždavinius, nustatykite apibrėžimo sritį, pertvarkykite reiškinį tik leistinais veiksmais, sprendinius patikrinkite pradinėje sąlygoje, o funkcijos uždaviniuose papildomai perskaitykite informaciją iš grafiko.

\textbf{Dažnos klaidos.} Pavojinga dalyti iš reiškinio nežinant, ar jis nelygus nuliui, kelti kvadratu nepatikrinus pašalinių sprendinių arba pamiršti funkcijos apibrėžimo sritį. Kiekvieną sprendimą verta baigti trumpu sakiniu: ką reiškia gautas skaičius, taškas, funkcija ar išvada.

\textbf{Savikontrolės klausimai.}
\begin{enumerate}[label=\arabic*.]
\item Nustatykite, kokios reikšmės yra leidžiamos, ir paaiškinkite kodėl.
\item Išspręskite uždavinį algebriniu ir grafiniu būdu.
\item Patikrinkite gautą sprendinį pradinėje lygtyje, nelygybėje arba modelyje.
\item Paaiškinkite, kaip ši tema siejasi su ankstesniu skyriumi ir kokioje realioje situacijoje ją pritaikytumėte.
\end{enumerate}

\textbf{Minimalus pasirengimas kitai temai.} Prieš eidami toliau, turite gebėti be pagalbos atpažinti uždavinio tipą, pasirinkti tinkamą metodą, užrašyti tarpinius veiksmus ir patikrinti atsakymą. Jei bent vienas žingsnis neaiškus, grįžkite prie iliustruojančių pavyzdžių ir išspręskite juos pakeisdami skaičius.

\section{Laipsninės, rodiklinės ir logaritminės funkcijos}\label{sec:laipsnines-rodiklines-ir-logaritmines-funkcijos}

\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Pasikartokite laipsnių savybes, šaknų apibrėžimą, logaritmo pradmenis, funkcijos apibrėžimo ir reikšmių sritis, grafiko transformacijas ir intervalų žymėjimą.
\end{tcolorbox}
\subsection{Apibrėžtys}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Laipsninės, rodiklinės ir logaritminės funkcijos}, svarbiausia suprasti skaičiaus prasmę, jo užrašymo formas, veiksmų tvarką, tikslumą ir atsakymo įvertinimą.

\textbf{Kaip mokytis.} Perskaitykite apibrėžtis, prie kiekvienos parašykite po savo pavyzdį ir vieną nepavyzdį. Spręsdami uždavinius, skaičių pirmiausia pavaizduokite skaičių tiesėje, schema arba ekvivalenčia forma. Tada taikykite veiksmų savybes, o pabaigoje patikrinkite dydžio eilę apytikriu skaičiavimu.

\textbf{Dažnos klaidos.} Dažniausiai klystama painiojant skaitiklį su vardikliu, procentą su procentiniu punktu, neigiamo skaičiaus ženklą arba logaritmo apibrėžimo sritį. Kiekvieną sprendimą verta baigti trumpu sakiniu: ką reiškia gautas skaičius, taškas, funkcija ar išvada.

\textbf{Savikontrolės klausimai.}
\begin{enumerate}[label=\arabic*.]
\item Perrašykite tą patį dydį bent trimis formomis: žodžiais, simboliais ir vaizdu.
\item Atlikite veiksmą dviem būdais ir palyginkite rezultatus.
\item Sugalvokite realią situaciją, kurioje šis skaičiavimo būdas padeda priimti sprendimą.
\item Paaiškinkite, kaip ši tema siejasi su ankstesniu skyriumi ir kokioje realioje situacijoje ją pritaikytumėte.
\end{enumerate}
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Reikia mokėti stačiojo trikampio sinusą, kosinusą ir tangentą, kampų matavimą laipsniais, koordinačių plokštumą, funkcijos grafiką ir periodiškumo idėją.
\end{tcolorbox}
\subsection{Apibrėžtys}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Trigonometrinės funkcijos}, svarbiausia suprasti kintamųjų prasmę, apibrėžimo sritį, lygiaverčius pertvarkius, grafiką ir rezultato interpretaciją.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Būtina suprasti vienetinį apskritimą, pagrindinių trigonometrinių funkcijų ženklus ketvirčiuose, periodą ir lygties sprendinių tikrinimą nurodytame intervale.
\end{tcolorbox}
\subsection{Apibrėžtys}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Trigonometrinės lygtys ir tapatybės}, svarbiausia suprasti kintamųjų prasmę, apibrėžimo sritį, lygiaverčius pertvarkius, grafiką ir rezultato interpretaciją.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Prieš ribas reikia mokėti skaityti funkcijos grafiką, rasti reikšmes iš lentelės ar formulės, dirbti su trupmeniniais reiškiniais ir suprasti artėjimą prie skaičiaus iš kairės ir dešinės.
\end{tcolorbox}
\subsection{Apibrėžtys}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Ribos ir tolydumas}, svarbiausia suprasti kintamųjų prasmę, apibrėžimo sritį, lygiaverčius pertvarkius, grafiką ir rezultato interpretaciją.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Reikia mokėti tiesės krypties koeficientą, vidutinį kitimo greitį, funkcijos grafiko liestinės idėją, ribos prasmę ir pagrindinius algebrinius pertvarkius.
\end{tcolorbox}
\subsection{Apibrėžtys}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Išvestinė ir diferencijavimas}, svarbiausia suprasti kintamųjų prasmę, apibrėžimo sritį, lygiaverčius pertvarkius, grafiką ir rezultato interpretaciją.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Pasikartokite išvestinės ženklą, funkcijos didėjimo ir mažėjimo intervalus, kvadratinių ir racionaliųjų reiškinių apibrėžimo sritis bei realaus modelio sąlygų užrašymą.
\end{tcolorbox}
\subsection{Apibrėžtys}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Išvestinės taikymai}, svarbiausia suprasti kintamųjų prasmę, apibrėžimo sritį, lygiaverčius pertvarkius, grafiką ir rezultato interpretaciją.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Reikia mokėti koordinačių plokštumą, atstumo tarp taškų formulę, tiesės lygtį, Pitagoro teoremą ir vektoriaus kaip kryptingo poslinkio sampratą.
\end{tcolorbox}
\subsection{Apibrėžtys}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Analitinė geometrija ir vektoriai}, svarbiausia suprasti brėžinį, duomenų žymėjimą, figūrų savybes, matavimo vienetus ir argumentuotą pagrindimą.

\textbf{Kaip mokytis.} Perskaitykite apibrėžtis, prie kiekvienos parašykite po savo pavyzdį ir vieną nepavyzdį. Spręsdami uždavinius, pradėkite nuo tikslaus brėžinio: pažymėkite žinomus dydžius, ieškomą dydį ir lygias ar lygiagrečias dalis. Tada pasirinkite teoremą, formulę arba koordinačių metodą.

\textbf{Dažnos klaidos.} Dažnai prarandami taškai, kai painiojamas plotas su perimetru, nepakeičiami vienetai, brėžinys laikomas įrodymu arba nepagrindžiamas figūrų panašumas. Kiekvieną sprendimą verta baigti trumpu sakiniu: ką reiškia gautas skaičius, taškas, funkcija ar išvada.

\textbf{Savikontrolės klausimai.}
\begin{enumerate}[label=\arabic*.]
\item Nubraižykite schemą ir joje pažymėkite visus duomenis.
\item Užrašykite, kokia teorema ar formulė taikoma, ir kodėl jos sąlygos tenkinamos.
\item Patikrinkite matavimo vienetus ir įvertinkite, ar atsakymas realistiškas.
\item Paaiškinkite, kaip ši tema siejasi su ankstesniu skyriumi ir kokioje realioje situacijoje ją pritaikytumėte.
\end{enumerate}
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Būtina prisiminti plokštumos figūrų plotus, stačiojo trikampio trigonometriją, erdvinių kūnų paviršiaus ploto ir tūrio formules bei pjūvio brėžinio skaitymą.
\end{tcolorbox}
\subsection{Apibrėžtys}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Erdvės geometrija}, svarbiausia suprasti brėžinį, duomenų žymėjimą, figūrų savybes, matavimo vienetus ir argumentuotą pagrindimą.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Reikia mokėti imties, požymio, vidurkio, medianos, kvartilių, dispersijos ir standartinio nuokrypio sampratas bei skaityti histogramas ir sklaidos diagramas.
\end{tcolorbox}
\subsection{Apibrėžtys}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Aprašomoji statistika ir normalusis modelis}, svarbiausia suprasti duomenų rinkimo tikslą, imtį, požymius, vaizdavimą, tikimybės modelį ir išvadų patikimumą.

\textbf{Kaip mokytis.} Perskaitykite apibrėžtis, prie kiekvienos parašykite po savo pavyzdį ir vieną nepavyzdį. Spręsdami uždavinius, atskirkite, kas yra populiacija, imtis, baigčių aibė arba atsitiktinis įvykis. Tada pasirinkite lentelę, diagramą, skaitinę charakteristiką arba kombinatorikos taisyklę.

\textbf{Dažnos klaidos.} Klaidingos išvados dažnai atsiranda, kai imtis nereprezentatyvi, sumaišomas dažnis su tikimybe arba skaičiuojant baigtis nepaisoma, ar tvarka svarbi. Kiekvieną sprendimą verta baigti trumpu sakiniu: ką reiškia gautas skaičius, taškas, funkcija ar išvada.

\textbf{Savikontrolės klausimai.}
\begin{enumerate}[label=\arabic*.]
\item Suformuluokite statistinį arba tikimybinį klausimą ir nurodykite, kokių duomenų reikia.
\item Pavaizduokite duomenis tinkama lentele ar diagrama ir paaiškinkite pasirinkimą.
\item Apskaičiuokite tikimybę arba charakteristiką ir parašykite išvadą pilnu sakiniu.
\item Paaiškinkite, kaip ši tema siejasi su ankstesniu skyriumi ir kokioje realioje situacijoje ją pritaikytumėte.
\end{enumerate}
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Pasikartokite baigčių aibę, įvykį, priešingą įvykį, nesutaikomus įvykius, daugybos taisyklę ir tikimybės formulę vienodai galimų baigčių atveju.
\end{tcolorbox}
\subsection{Apibrėžtys}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Sąlyginė tikimybė ir nepriklausomumas}, svarbiausia suprasti kintamųjų prasmę, apibrėžimo sritį, lygiaverčius pertvarkius, grafiką ir rezultato interpretaciją.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Reikia mokėti skaičių aibių grandinę, intervalus, poaibio idėją, Venno diagramas ir loginių jungčių „ir“, „arba“, „ne“ prasmę.
\end{tcolorbox}
\subsection{Apibrėžtys}
\begin{apibreztis}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Skaičių aibės ir veiksmai su aibėmis}, svarbiausia suprasti skaičiaus prasmę, jo užrašymo formas, veiksmų tvarką, tikslumą ir atsakymo įvertinimą.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Pasikartokite skaičių tiesę, atstumą tarp taškų, intervalų žymėjimą ir tiesinių nelygybių sprendimą.
\end{tcolorbox}
\subsection{Apibrėžtys}
\begin{apibreztis}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Realiojo skaičiaus modulis}, svarbiausia suprasti skaičiaus prasmę, jo užrašymo formas, veiksmų tvarką, tikslumą ir atsakymo įvertinimą.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Reikia mokėti laipsnių savybes, šaknų apibrėžimą, racionaliuosius rodiklius, logaritmo apibrėžimą ir apibrėžimo sričių tikrinimą.
\end{tcolorbox}
\subsection{Apibrėžtys}
\begin{apibreztis}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Šaknys, laipsniai ir logaritmai}, svarbiausia suprasti skaičiaus prasmę, jo užrašymo formas, veiksmų tvarką, tikslumą ir atsakymo įvertinimą.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Būtina prisiminti stačiojo trikampio trigonometrinius santykius, vienetinį apskritimą, funkcijos reikšmių sritį ir kampų reikšmes specialiesiems kampams.
\end{tcolorbox}
\subsection{Apibrėžtys}
\begin{apibreztis}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Sinusas, kosinusas, tangentas ir atvirkštinės reikšmės}, svarbiausia suprasti sąvokas, formules, vaizdavimą ir sprendimo būdo pasirinkimą.

\textbf{Kaip mokytis.} Perskaitykite apibrėžtis, prie kiekvienos parašykite po savo pavyzdį ir vieną nepavyzdį. Spręsdami uždavinius, pirmiausia užrašykite, kas duota ir ko ieškoma, tada pasirinkite tinkamą apibrėžimą arba formulę, atlikite veiksmus ir patikrinkite, ar atsakymas prasmingas.

\textbf{Dažnos klaidos.} Dažna klaida yra pradėti skaičiuoti neįvardijus sąlygų, todėl pametama prasmė arba pasirenkama netinkama formulė. Kiekvieną sprendimą verta baigti trumpu sakiniu: ką reiškia gautas skaičius, taškas, funkcija ar išvada.

\textbf{Savikontrolės klausimai.}
\begin{enumerate}[label=\arabic*.]
\item Paaiškinkite pagrindinę sąvoką savais žodžiais ir pateikite du pavyzdžius.
\item Išspręskite vieną skaitinį ir vieną tekstinį uždavinį, užrašydami visus žingsnius.
\item Sukurkite priešingą arba ribinį pavyzdį, kuris parodytų, kada taisyklės taikyti negalima.
\item Paaiškinkite, kaip ši tema siejasi su ankstesniu skyriumi ir kokioje realioje situacijoje ją pritaikytumėte.
\end{enumerate}
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Reikia mokėti funkcijos apibrėžimo ir reikšmių sritis, nulinius taškus, monotoniškumą, lyginumą, nelyginumą, periodiškumą ir grafiko transformacijas.
\end{tcolorbox}
\subsection{Apibrėžtys}
\begin{apibreztis}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Bendroji funkcijų teorija}, svarbiausia suprasti kintamųjų prasmę, apibrėžimo sritį, lygiaverčius pertvarkius, grafiką ir rezultato interpretaciją.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Pasikartokite ekvivalenčius lygčių pertvarkius, logaritmų savybes, racionaliųjų reiškinių vardiklių tikrinimą ir pašalinių sprendinių atmetimą.
\end{tcolorbox}
\subsection{Apibrėžtys}
\begin{apibreztis}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Rodiklinės, logaritminės ir racionaliosios lygtys}, svarbiausia suprasti skaičiaus prasmę, jo užrašymo formas, veiksmų tvarką, tikslumą ir atsakymo įvertinimą.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Reikia mokėti spręsti intervalų metodu, tikrinti apibrėžimo sritį ir prisiminti, kada logaritminė ar rodiklinė funkcija didėja arba mažėja.
\end{tcolorbox}
\subsection{Apibrėžtys}
\begin{apibreztis}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Rodiklinės, logaritminės ir racionaliosios nelygybės}, svarbiausia suprasti skaičiaus prasmę, jo užrašymo formas, veiksmų tvarką, tikslumą ir atsakymo įvertinimą.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Pasikartokite vektoriaus koordinates, vektorių sudėtį, atimtį, dauginimą iš skaičiaus, atkarpos vidurio tašką ir Pitagoro teoremą.
\end{tcolorbox}
\subsection{Apibrėžtys}
\begin{apibreztis}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Plokštumos vektoriai ir veiksmai su jais}, svarbiausia suprasti brėžinį, duomenų žymėjimą, figūrų savybes, matavimo vienetus ir argumentuotą pagrindimą.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Reikia mokėti rinkti duomenis, skirti kokybinius ir kiekybinius požymius, sudaryti dažnių lenteles, histogramas ir interpretuoti sklaidos matus.
\end{tcolorbox}
\subsection{Apibrėžtys}
\begin{apibreztis}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Įvadas į statistinę duomenų analizę}, svarbiausia suprasti duomenų rinkimo tikslą, imtį, požymius, vaizdavimą, tikimybės modelį ir išvadų patikimumą.
...
\begin{tcolorbox}[title=Prieš pradedant, colback=green!5]
Pasikartokite daugybos ir sudėties taisykles, faktorialą, tvarkos svarbos klausimą ir tikimybių uždavinius su baigčių skaičiavimu.
\end{tcolorbox}
\subsection{Apibrėžtys}
\begin{apibreztis}
...
Ši tema turi būti mokomasi ne kaip atskirų formulių sąrašas, o kaip nuoseklus įrankių rinkinys. Mokantis skyriaus \textit{Rinkiniai: kėliniai, gretiniai, deriniai}, svarbiausia suprasti duomenų rinkimo tikslą, imtį, požymius, vaizdavimą, tikimybės modelį ir išvadų patikimumą.
